...
See [`TestLogs.cs`](https://github.com/open-telemetry/opentelemetry-dotnet/blob/core-1.15.0/src/OpenTelemetry.Exporter.OpenTelemetryProtocol/../../examples/Console/TestLogs.cs) for example on how to
...
[Console](https://github.com/open-telemetry/opentelemetry-dotnet/blob/core-1.15.0/src/OpenTelemetry.Exporter.OpenTelemetryProtocol/../../docs/logs/getting-started-console/README.md) or [ASP.NET
Core](https://github.com/open-telemetry/opentelemetry-dotnet/blob/core-1.15.0/src/OpenTelemetry.Exporter.OpenTelemetryProtocol/../../docs/logs/getting-started-aspnetcore/README.md) tutorial.
...
[IncludeScopes](https://github.com/open-telemetry/opentelemetry-dotnet/blob/core-1.15.0/src/OpenTelemetry.Exporter.OpenTelemetryProtocol/../../docs/logs/customizing-the-sdk/Readme.md#includescopes)
...
[`TestMetrics.cs`](https://github.com/open-telemetry/opentelemetry-dotnet/blob/core-1.15.0/src/OpenTelemetry.Exporter.OpenTelemetryProtocol/../../examples/Console/TestMetrics.cs) for example on how to
...
See the [`TestOtlpExporter.cs`](https://github.com/open-telemetry/opentelemetry-dotnet/blob/core-1.15.0/src/OpenTelemetry.Exporter.OpenTelemetryProtocol/../../examples/Console/TestOtlpExporter.cs) for
runnable example.
...
> The cross cutting extension is currently only available when using the
  ...
  [OpenTelemetry.Extensions.Hosting](https://github.com/open-telemetry/opentelemetry-dotnet/blob/core-1.15.0/src/OpenTelemetry.Exporter.OpenTelemetryProtocol/../OpenTelemetry.Extensions.Hosting/README.md)
  package.
...
* Calling `UseOtlpExporter` automatically enables logging, metrics, and tracing
  ...
  * Logging
    ...
    Filtering](https://github.com/open-telemetry/opentelemetry-dotnet/blob/core-1.15.0/src/OpenTelemetry.Exporter.OpenTelemetryProtocol/../../docs/logs/customizing-the-sdk/README.md#log-filtering) and
    [Logging in
  ...
  * Metrics
    ...
    For details see: [Meter](https://github.com/open-telemetry/opentelemetry-dotnet/blob/core-1.15.0/src/OpenTelemetry.Exporter.OpenTelemetryProtocol/../../docs/metrics/customizing-the-sdk/README.md#meter).
  ...
  * Tracing
    ...
    For details see: [Activity Source](https://github.com/open-telemetry/opentelemetry-dotnet/blob/core-1.15.0/src/OpenTelemetry.Exporter.OpenTelemetryProtocol/../../docs/trace/customizing-the-sdk/README.md#activity-source).
...
troubleshooting](https://github.com/open-telemetry/opentelemetry-dotnet/blob/core-1.15.0/src/OpenTelemetry.Exporter.OpenTelemetryProtocol/../OpenTelemetry/README.md#troubleshooting) for instructions on
