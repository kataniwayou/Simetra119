# Scenario 09: event_errors metric exists (sentinel check)
# This counter only increments under abnormal conditions (pipeline exceptions).
...
SCENARIO_NAME="event_errors metric registered in Prometheus"
METRIC="snmp_event_errors_total"
